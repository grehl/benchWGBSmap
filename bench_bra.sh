...
readDir=../data/bra/simulatedCov5BsReads/
outDir=../data/bra/tmp_bra/benchmarkCov5
benchDir=../results/bra/benchmarkCov5
...
#    /usr/bin/time -f "%K\t%M\t%E\t%S\t%U" -o ${benchDir}/${mapper}/${run}.csv -a \
#    segemehl.x \
#        -i ${genomeDir}/Brassica_napus.AST_PRJEB5043_v1.dna.toplevel.segemehl.ctidx \
#        -j ${genomeDir}/Brassica_napus.AST_PRJEB5043_v1.dna.toplevel.segemehl.gaidx \
#        -d ${genomeDir}/Brassica_napus.AST_PRJEB5043_v1.dna.toplevel.fa \
