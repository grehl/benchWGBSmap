...
samp1<-read.csv("/home/user/IANVS/benchmarkWGBS/data/bra/mappedCov5BsReads/bismark/mm_0/simulatedConvRate100ErrRate0mm_0bismark/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp1$mapper<- "bismark"
samp1$error<-"0"
samp2<-read.csv("/home/user/IANVS/benchmarkWGBS/data/bra/mappedCov5BsReads/bismark/mm_0/simulatedConvRate100ErrRate1mm_0bismark/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp2$mapper<- "bismark"
samp2$error<-"1"
samp3<-read.csv("/home/user/IANVS/benchmarkWGBS/data/bra/mappedCov5BsReads/gsnap/mm_0/simulatedConvRate100ErrRate0mm_0gsnap/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp3$mapper <- "gsnap"
samp3$error<-"0"
samp4<-read.csv("/home/user/IANVS/benchmarkWGBS/data/bra/mappedCov5BsReads/gsnap/mm_0/simulatedConvRate100ErrRate1mm_0gsnap/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp4$mapper <- "gsnap"
samp4$error<-"1"
samp5<-read.csv("/home/user/IANVS/benchmarkWGBS/data/bra/mappedCov5BsReads/gem3/mm_0/simulatedConvRate100ErrRate0mm_0gem3/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp5$mapper <- "gem3" 
samp5$error <- "0"
samp6<-read.csv("/home/user/IANVS/benchmarkWGBS/data/bra/mappedCov5BsReads/gem3/mm_0/simulatedConvRate100ErrRate1mm_0gem3/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp6$mapper <- "gem3" 
samp6$error <- "1"
samp7<-read.csv("/home/user/IANVS/benchmarkWGBS/data/bra/mappedCov5BsReads/bwameth/mm_0/simulatedConvRate100ErrRate0mm_0bwameth/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp7$mapper <- "bwameth" 
samp7$error <- "0"
samp8<-read.csv("/home/user/IANVS/benchmarkWGBS/data/bra/mappedCov5BsReads/bwameth/mm_0/simulatedConvRate100ErrRate1mm_0bwameth/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp8$mapper <- "bwameth" 
samp8$error <- "1"
samp9<-read.csv("/home/user/IANVS/benchmarkWGBS/data/bra/mappedCov5BsReads/bsseeker2/mm_0/simulatedConvRate100ErrRate0mm_0bsseeker2/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp9$mapper <- "bsseeker2" 
samp9$error <- "0"
samp10<-read.csv("/home/user/IANVS/benchmarkWGBS/data/bra/mappedCov5BsReads/bsseeker2/mm_0/simulatedConvRate100ErrRate1mm_0bsseeker2/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp10$mapper <- "bsseeker2" 
samp10$error <- "1"
samp11<-read.csv("/home/user/IANVS/benchmarkWGBS/data/bra/mappedCov5BsReads/bismarkbwt2/mm_0/simulatedConvRate100ErrRate0mm_0bismarkbwt2/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp11$mapper <- "bismarkbwt2" 
samp11$error <- "0"
samp12<-read.csv("/home/user/IANVS/benchmarkWGBS/data/bra/mappedCov5BsReads/bismarkbwt2/mm_0/simulatedConvRate100ErrRate1mm_0bismarkbwt2/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp12$mapper <- "bismarkbwt2" 
samp12$error <- "1"
samp13<-read.csv("/home/user/IANVS/benchmarkWGBS/data/bra/mappedCov5BsReads/bsmap/mm_0/simulatedConvRate100ErrRate0mm_0bsmap/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp13$mapper <- "bsmap" 
samp13$error <- "0"
samp14<-read.csv("/home/user/IANVS/benchmarkWGBS/data/bra/mappedCov5BsReads/bsmap/mm_0/simulatedConvRate100ErrRate1mm_0bsmap/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp14$mapper <- "bsmap" 
samp14$error <- "1"
...
geom_ribbon(aes(ymin=coverage - stder,
                ymax=coverage + stder,
                group = mapper,fill=mapper,color=mapper),alpha = 0.1) 
...
samp1<-read.csv("/home/user/IANVS/benchmarkWGBS/data/sol/mappedCov5BsReads/bismark/mm_0/simulatedConvRate100ErrRate0mm_0bismark/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp1$mapper<- "bismark"
samp1$error<-"0"
samp2<-read.csv("/home/user/IANVS/benchmarkWGBS/data/sol/mappedCov5BsReads/bismark/mm_0/simulatedConvRate100ErrRate1mm_0bismark/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp2$mapper<- "bismark"
samp2$error<-"1"
samp3<-read.csv("/home/user/IANVS/benchmarkWGBS/data/sol/mappedCov5BsReads/gsnap/mm_0/simulatedConvRate100ErrRate0mm_0gsnap/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp3$mapper <- "gsnap"
samp3$error<-"0"
samp4<-read.csv("/home/user/IANVS/benchmarkWGBS/data/sol/mappedCov5BsReads/gsnap/mm_0/simulatedConvRate100ErrRate1mm_0gsnap/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp4$mapper <- "gsnap"
samp4$error<-"1"
samp5<-read.csv("/home/user/IANVS/benchmarkWGBS/data/sol/mappedCov5BsReads/gem3/mm_0/simulatedConvRate100ErrRate0mm_0gem3/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp5$mapper <- "gem3" 
samp5$error <- "0"
samp6<-read.csv("/home/user/IANVS/benchmarkWGBS/data/sol/mappedCov5BsReads/gem3/mm_0/simulatedConvRate100ErrRate1mm_0gem3/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp6$mapper <- "gem3" 
samp6$error <- "1"
samp7<-read.csv("/home/user/IANVS/benchmarkWGBS/data/sol/mappedCov5BsReads/bwameth/mm_0/simulatedConvRate100ErrRate0mm_0bwameth/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp7$mapper <- "bwameth" 
samp7$error <- "0"
samp8<-read.csv("/home/user/IANVS/benchmarkWGBS/data/sol/mappedCov5BsReads/bwameth/mm_0/simulatedConvRate100ErrRate1mm_0bwameth/raw_data_qualimapReport/coverage_across_reference.txt", skip = 1, header = F, sep = "" , dec = ".", quote="")
samp8$mapper <- "bwameth" 
samp8$error <- "1"

samp_combined<-rbind(samp1,samp2,samp5,samp6,samp7,samp8)
colnames(samp_combined)<- header
