...
MAPPERLIST=(bismarkbwt2 bismark)
...
readDir=../data/zea/simulatedCov5BsReads/
outDir=../data/zea/tmp_zea/benchmarkCov5
benchDir=../results/zea/benchmarkCov5
...
#    /usr/bin/time -f "%K\t%M\t%E\t%S\t%U" -o ${benchDir}/${mapper}/${run}.csv -a \
#    segemehl.x \
#        -i ${genomeDir}/Zea_mays.B73_RefGen_v4.dna.toplevel.segemehl.ctidx \
#        -j ${genomeDir}/Zea_mays.B73_RefGen_v4.dna.toplevel.segemehl.gaidx \
#        -d ${genomeDir}/Zea_mays.B73_RefGen_v4.dna.toplevel.fa \
