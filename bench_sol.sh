...
readDir=../data/sol/simulatedCov5BsReads/
outDir=../data/sol/tmp_sol/benchmarkCov5
benchDir=../results/sol/benchmarkCov5
...
do
    ...
    /usr/bin/time -f "%K\t%M\t%E\t%S\t%U" -o ${benchDir}/${mapper}/${run}.csv -a \
    segemehl.x \
        -i ${genomeDir}/Solanum_tuberosum.SolTub_3.0.dna.toplevel.segemehl.ctidx \
        -j ${genomeDir}/Solanum_tuberosum.SolTub_3.0.dna.toplevel.segemehl.gaidx \
        -d ${genomeDir}/Solanum_tuberosum.SolTub_3.0.dna.toplevel.fa \
